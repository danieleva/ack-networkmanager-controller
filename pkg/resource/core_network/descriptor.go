...
const (
	FinalizerString = "finalizers.networkmanager.services.k8s.aws/CoreNetwork"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("corenetworks")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.CoreNetwork{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.CoreNetwork),
	}
}
